...
2. Open SQL Editor, create a new query, paste all of `supabase/SETUP.sql`, and run it once. It already contains every ordered migration through v12; do not run the individual migrations again on a new project. Supabase CLI users may run `supabase db push` instead.
