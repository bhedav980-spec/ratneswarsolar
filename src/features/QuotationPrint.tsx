    ...
    <div className="print-preview-stage"><article className="pdf-document-stack word-quote-stack">
      <section className="a4-document pdf-page word-quote-page">
        <Header/><main className="word-quote-body word-quote-page-one">
          ...
          <section className="word-subsidy"><h2 className="word-section-title">SUBSIDY DETAILS</h2><table><thead><tr><th>Sr. No</th><th>Description</th><th>Amount</th></tr></thead><tbody>{quote.subsidy.eligible?<><tr><td>1</td><td>Central / Scheme Subsidy</td><td>{formatInr(quote.subsidy.central)}</td></tr>{quote.subsidy.state>0&&<tr><td>2</td><td>State Subsidy</td><td>{formatInr(quote.subsidy.state)}</td></tr>}<tr><td></td><th>Total Indicative Subsidy</th><th>{formatInr(quote.subsidy.total)}</th></tr></>:<tr><td>1</td><td>Subsidy</td><td>Not Applicable</td></tr>}</tbody></table></section>
